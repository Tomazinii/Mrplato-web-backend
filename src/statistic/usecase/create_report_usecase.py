...
class CreateReportUsecase(UsecaseInterface):
    ...
    def execute(self, classroom_id: str):
        ...
        with open(file_path, mode='w', newline='', encoding='utf-8') as arquivo_csv:
            campos = ["id", "classroom_id", "activity_id", "student_id", "student_name", "student_enrollment", "student_email", "time_mrplato", "num_attempts", "num_backs", "num_errors", "problem_id", "problem", "solution", "time_activity_expires"]
